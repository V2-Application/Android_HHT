 ...
 * Use the {@link StoredStockFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StoredStockFragment extends Fragment implements View.OnClickListener {

    private EditText site,dt,bin,article,scan_qty;
    private Activity activity;
    private String URL ="";
    private String TAG ="StoredStackFragment";
    private View view;
    private Button back,reset,save,site_scan;
     ...
     * @return A new instance of fragment StoredStockFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static StoredStockFragment newInstance(String param1, String param2) {
        StoredStockFragment fragment = new StoredStockFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_stored_stock, container, false);
        ...
        scan_qty = view.findViewById(R.id.scan_qty);
        save = view.findViewById(R.id.save);
        reset = view.findViewById(R.id.reset);
        back = view.findViewById(R.id.back);
        back = view.findViewById(R.id.back);
        site_scan = view.findViewById(R.id.site_scan);

        save.setOnClickListener(this);
        reset.setOnClickListener(this);
        back.setOnClickListener(this);
        site_scan.setOnClickListener(this);
    ...
    private void validateStoNumber() {
        ...
        String d = dt.getText().toString().trim();

        if (TextUtils.isEmpty(site.getText().toString())&& s.equals("")) {
            box.getBox("Alert", "Please fill Site .");
            return;
        }
        if (TextUtils.isEmpty(dt.getText().toString())&& d.equals("")) {
            box.getBox("Alert", "Please fill Date .");
            return;
        }
    ...
    void sendValidateStoNumberJson(String Number) {
    ...
    private void saveDataToServer(){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                String sq = scan_qty.getText().toString().trim();
                ...
                if (TextUtils.isEmpty( scan_qty.getText().toString())& sq.equals(""))
                {		tag = "Scan Qty";
                }
...
//                                        gr.requestFocus();
    ...
    public void onResume() {
        ...
        ((Process_Selection_Activity) getActivity())
                .setActionBarTitle("Stored Stock");
    }
}